...
QALM=TransformData(ResizeData(2, GenerateUnlabeledData(50)))
print(QALM)
print(np.shape(QALM))


"""
oui=GenerateData(1,1,1)
print(oui)
dataa=GenerateUnlabeledData(1)
#DisplayData(dataa)
oklm=ResizeData(16,dataa)
#print(dataa)
print(np.shape(oklm))
print(len(oklm))
okidoki=TransformData(oklm)
print(okidoki)
"""


#newdatao = ResizeData(8, dataa)
#print(newdatao)
#DisplayData(newdatao)
...
"""newdata = cv2.resize(dataa[0], (16, 16))
print(newdata)"""
