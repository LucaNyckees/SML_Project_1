...
def derivative_vector(X,f,l,u,sigma,eps,temp,W,P):
    ...
    a = np.matmul(partial_deriv_P_tilde_in_blocks(X,sigma,eps,l,u,W,P)[3],unlabeled_part(f,l,u))
    b = np.matmul(partial_deriv_P_tilde_in_blocks(X,sigma,eps,l,u,W,P)[2],labeled_part(f,l,u))
